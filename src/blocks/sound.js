...
ScratchBlocks.Blocks['sound_seteffectto'] = {
  init() {
    this.jsonInit({
      message0: ScratchBlocks.Msg.SOUND_SETEFFECTO,
      args0: [
        {
          type: 'field_dropdown',
          name: 'EFFECT',
          options: [
            ...
            [ScratchBlocks.Msg.SOUND_EFFECTS_TEMPO, 'TEMPO'],
          ],
        },
        {
          type: 'input_value',
...
ScratchBlocks.Blocks['sound_changeeffectby'] = {
  init() {
    this.jsonInit({
      message0: ScratchBlocks.Msg.SOUND_CHANGEEFFECTBY,
      args0: [
        {
          type: 'field_dropdown',
          name: 'EFFECT',
...
ScratchBlocks.Blocks['sound_cleareffects'] = {
  init() {
    this.jsonInit({
      message0: ScratchBlocks.Msg.SOUND_CLEAREFFECTS,
      category: ScratchBlocks.Categories.sound,
      extensions: ['colours_sounds', 'shape_statement'],
    });
  },
